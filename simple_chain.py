...
def main():
    print("Simple Chaining")
    information = """
    Elon Reeve Musk[b] (born June 28, 1971) is a businessman and entrepreneur known for his leadership of Tesla, SpaceX, X, and xAI. Musk has been the wealthiest person in the world since 2021; as of December 2025, Forbes estimates his net worth to be around $749 billion.
    ...
    prompt_template = """
    Given the information {information} about a person, I want you ti create:
    1. A short summary
    2. two funny facts about the person.

    You must generate the response in a markdown style.
    """

    summary_prompt_template = PromptTemplate(
        input_variables=["information"],  # it always has to be a list and match order
        template=prompt_template,
    )
    # prompt template helps to overcome prompt injection attacks
    ...
    # invoke the chain
    resp = chain.invoke({"information": information})
